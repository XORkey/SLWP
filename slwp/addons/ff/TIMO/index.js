...
function Key(index)
{
	var Z = ['124650930', '38340233', '0x4482da43', '1731291748', '3591808561', '27727222', '109955291', '917383411', '854323307', '89283442'];
											// The key ring is fixed in this demo.
	return parseInt(Z[index]) >>> 0;
}
function FindKeyIndex(host)
{
	return 2;								// Force key for this demo.
}
function Hex32(n)
{
    var prefix = ""; 
...
function Au(Ru, host)
{
	return (Ru ^ Key(FindKeyIndex(host))) >>> 0;
}
function Rs(Ps, host)
{
	return (Ps ^ Key(FindKeyIndex(host))) >>> 0;
}
