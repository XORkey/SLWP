...
\item All user keys are put on a key ring,
which is a set of at least 99 keys, most of them dummies.
No other information whatsoever is stored in a key ring, which may be stored in an encrypted file.
\item The user selects which key is used for what, which he/she needs to write down or remember.
